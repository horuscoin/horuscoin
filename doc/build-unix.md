UNIX BUILD NOTES
====================
Some notes on how to build Horuscoin in Unix. 
...
This will build horuscoin-qt as well if the dependencies are met.
...
If you want to build Horuscoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a horuscoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip horuscoind" to strip the debug
