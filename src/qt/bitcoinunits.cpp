...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MRx: return QString("MRx");
    case kRx: return QString("kRx");
    case Rx: return QString("Rx");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MRx: return QString("Mega-Horuscoin (1,000,000 Rx)");
    case kRx: return QString("Kilo-Horuscoin (1000 Rx)");
    case Rx: return QString("Horuscoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MRx: return Q_INT64_C(100000000000000);
    case kRx: return Q_INT64_C(100000000000);
    case Rx:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MRx: return Q_INT64_C(900000);
    case kRx: return Q_INT64_C(900000000);
    case Rx:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MRx: return 6;  // 900,000 (# digits, without commas)
    case kRx: return 9;  // 900,000,000
    case Rx:  return 12; // 900,000,000,000
