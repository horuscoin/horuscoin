...
static const unsigned int MAX_BLOCK_SIGOPS = MAX_BLOCK_SIZE/52;
/** The maximum number of orphan transactions kept in memory */
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/104;
...
inline bool AllowFree(double dPriority)
{
    ...
    // need a fee.
        return dPriority > COIN * 960 / 250; // Horuscoin: 960 blocks found a day. Priority cutoff is 100 horuscoin day / 250 bytes.
    }
