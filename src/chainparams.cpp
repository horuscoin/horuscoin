...
// Copyright (c)      2014 The Megcoin developers
// Copyright (c)      2014 The Horuscoin developers
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0469175ff80b4adaf2fc24d6da5b0b50399e05acc55b4278550971c41251353c72b057f84cfe51dcec18d729afbff430cc20154c97a1306e05df6dfb2dccb1d7aa");
        nDefaultPort = 10027;
        nRPCPort = 10026;
        ...
        const char* pszTimestamp = "Wakatobi Flowerpecker: New Colourful Species of Bird Discovered in Indonesia";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 52 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ddf7c7f24141093a18b7e90ced56b974a549fb9aaa580a5e7796155c824d8a41311b84f5b1dc71476c6f9448b6da9fa33fc3280b387e2aa73c9bc617ed56865e") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1401983058;
        genesis.nNonce = 945948;
        ...
        assert(hashGenesisBlock == uint256("0xa3ad4046363cebfa478468a2e696e3906109fc0a8989ca544c177b3e2cfa32e1"));
        assert(genesis.hashMerkleRoot == uint256("0x3ee1f22f6cd437203be51f154c1ca25848282d1781d69c28d947be90cade0235"));
        //use plenty of different domains to ensure if one goes down it will still work
        vSeeds.push_back(CDNSSeedData("seed1.horuscoin.info", "seed2.horuscoin.info"));
        vSeeds.push_back(CDNSSeedData("seed3.horuscoin.info", "seed4.horuscoin.info"));
        vSeeds.push_back(CDNSSeedData("seed5.horuscoin.info", "seed6.horuscoin.info"));

        // Workaround for Boost not being quite compatible with C++11;
        std::vector<unsigned char> pka = list_of(60); //`R`
        base58Prefixes[PUBKEY_ADDRESS] = pka;
        
        std::vector<unsigned char> sca = list_of(40); //'H'
        base58Prefixes[SCRIPT_ADDRESS] = sca;
        
        std::vector<unsigned char> sk  = list_of(137);
        base58Prefixes[SECRET_KEY]     = sk;
        
        std::vector<unsigned char> epk = list_of(0x04)(0x88)(0xB4)(0xE3);
        base58Prefixes[EXT_PUBLIC_KEY] = epk;
        
        std::vector<unsigned char> esk = list_of(0x04)(0x88)(0xC3)(0xAD);
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1401733496;
        genesis.nNonce = 668077;
        hashGenesisBlock = genesis.GetHash();
        ...
        //assert(hashGenesisBlock == uint256("0x00646a008dd2bdc24691c9c46cdea71ff24955881e1a7a35cb55bf29d3c0ec49"));
        //assert(genesis.hashMerkleRoot == uint256("0xf9ebfd33e3128cfa08d2f97449dc1d4b1ca7c1765e3e228cf8a9f8e225b8de15"));
        vFixedSeeds.clear();
        vSeeds.clear();
        //use plenty of different domains to ensure if one goes down it will still work
        vSeeds.push_back(CDNSSeedData("seed1.horuscoin.info", "seed2.horuscoin.info"));
        ...
        std::vector<unsigned char> pka = list_of(122); //r
        base58Prefixes[PUBKEY_ADDRESS] = pka;
        std::vector<unsigned char> sca = list_of(100);
        base58Prefixes[SCRIPT_ADDRESS] = sca;
        std::vector<unsigned char> sk  = list_of(75);
        base58Prefixes[SECRET_KEY]     = sk;
        std::vector<unsigned char> epk = list_of(0x04)(0x35)(0xAD)(0x94);
        base58Prefixes[EXT_PUBLIC_KEY] = epk;
        std::vector<unsigned char> esk = list_of(0x04)(0x35)(0xC4)(0x94);
        base58Prefixes[EXT_SECRET_KEY] = esk;
    }
